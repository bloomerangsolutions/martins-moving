...
const config: Config = {
  darkMode: "class",
  content: ["./app/**/*.{ts,tsx}", "./components/**/*.{ts,tsx}", "./lib/**/*.{mjs,ts}"],
  theme: {
    extend: {
      colors: {
      ...
      fontFamily: {
        "headline-md": ["var(--font-sora)", "system-ui", "sans-serif"],
        "body-lg": ["var(--font-hanken)", "system-ui", "sans-serif"],
        "caption": ["var(--font-hanken)", "system-ui", "sans-serif"],
        "display-lg": ["var(--font-sora)", "system-ui", "sans-serif"],
        "headline-lg-mobile": ["var(--font-sora)", "system-ui", "sans-serif"],
        "body-md": ["var(--font-hanken)", "system-ui", "sans-serif"],
        "headline-lg": ["var(--font-sora)", "system-ui", "sans-serif"],
