...
/* snail mascot: travels the homepage on scroll (GSAP ScrollTrigger + MotionPath) */
#snail-trail{position:fixed;left:0;top:0;opacity:0;z-index:8;pointer-events:none;}
#snail-trail img{display:block;width:100%;height:auto;}
body.home main > section,body.home main > div{position:relative;z-index:10;}
</style>
`;
